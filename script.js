...
const displayPost = posts =>{
    ...
    posts.forEach(post => {
        ...
        displayPostDiv.classList="flex flex-col";
        displayPostDiv.innerHTML = `<div class="w-4/5 bg-blue-200 p-6 mx-auto border rounded-lg border-blue-950">
        <div class="flex flex-row justify-between">
            <!-- div for avatar -->
            <div>
                <div id="avatar-online" class="avatar online">
            ...
            <div>
                ...
                <p id="item-title">${post.title}</p>
                <p id="item-description">${post.description}</p>
                    <hr>
